...
CONFIG = {
    "random_seed": 42,
    "num_pairs": 6, #100,
    "optimizer_batch_size": 6,

    # diffusion schedule (descending = coarse → fine)
    "time_schedule": [0.25], #[0.13, 0.12, 0.11, 0.10, 0.09, 0.08, 0.07, 0.06, 0.05, 0.04], #[0.18, 0.17, 0.16, 0.15, 0.14, 0.13, 0.12, 0.11, 0.10], #[0.18, 0.17, 0.16, 0.15, 0.14, 0.13, 0.12, 0.11, 0.09, 0.07], #[0.18, 0.17, 0.16, 0.15, 0.14, 0.13, 0.11, 0.09, 0.07, 0.05, 0.04],
    ...
    "init_method": "linear",        # {"tproject","linear"}
    "init_nseeds": 20, 
