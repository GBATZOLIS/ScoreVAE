...
def get_config():
    ...
    cfg.experiment    = "rotmnist/codim_1/iso_MECAE_v2"
    ...
    # local isometry regs
    loss.enc_iso_weight   = 0.04
    loss.dec_iso_weight   = 0.04
    loss.num_v            = 1
    ...
    lat.lam_metric       = 1e-3
    lat.t_value          = 0.05
    lat.diffusion_config = "configs/rotated_mnist/autoencoder/latent_config.py"
